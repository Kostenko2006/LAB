...
namespace HospitalManagementSystem
{
    public class Hospital
    {
        ...
        {
            List<MedicalRecord> patientRecords = new List<MedicalRecord>();
        ...
        public string GetStatistics()
        {
            ...
            string result = "\n=== СТАТИСТИКА ЛІКАРНІ ===\n";
            result += $"Кількість лікарів: {Doctors.Count}\n";
            result += $"Кількість зареєстрованих пацієнтів: {Patients.Count}\n";
            result += $"Кількість палат: {Rooms.Count}\n";
            result += $"Кількість пацієнтів у палатах: {totalPatientsInRooms}\n";
            result += $"Кількість медичних записів: {Records.Count}\n";
